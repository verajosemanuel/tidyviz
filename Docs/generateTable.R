...
mycran <- rio::import("Docs/list_cran.csv") %>% as.data.frame()
...
rio::export(df, file = "Docs/cran_packages.xlsx", format = "xlsx" )
write.csv(df, file = "Docs/cran_packages.csv", row.names = FALSE, sep = ';')
