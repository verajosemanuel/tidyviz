...
<tbody>
  <tr>
   <td style="text-align:left;"> addinslist </td>
   <td style="text-align:left;"> Discover and Install Useful RStudio Addins </td>
   <td style="text-align:left;"> Browse through a continuously updated list of existing RStudio 
    addins and install/uninstall their corresponding packages. </td>
   <td style="text-align:left;"> https://github.com/daattali/addinslist </td>
  </tr>
  <tr>
...
Theory Group (Formerly: E1071), TU Wien </td>
  ...
  <tr>
   ...
   <td style="text-align:left;"> Handy string and file processing and manipulation tools. Built on 
    top of the functionality of 'stringr'. Good for those who like to do
    all of their file and string manipulation from within R. </td>
...
https://www.unidata.ucar.edu/software/udunits/ </td>
  ...
  <tr>
   <td style="text-align:left;"> VIMGUI </td>
   <td style="text-align:left;"> Visualization and Imputation of Missing Values - Graphical User
Interface </td>
   <td style="text-align:left;"> A graphical user interface for the methods implemented in the
    package VIM. It allows an easy handling of the
    implemented plot and imputation methods. </td>
   <td style="text-align:left;"> https://github.com/alexkowa/VIMGUI </td>
  </tr>
  <tr>
